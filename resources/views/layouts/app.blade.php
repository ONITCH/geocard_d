    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div class="bg-white pt-12 sm:pt-16 lg:pt-24 w-screen">
            ...
            <div class="navbar-bottom">
                <nav
                    class="mx-auto flex w-full justify-between gap-8 border-t bg-white px-10 py-4 text-xs sm:max-w-md sm:rounded-t-xl sm:border-transparent sm:text-sm sm:shadow-2xl　">
                    <span>&nbsp;</span>
                    <a href="#"
